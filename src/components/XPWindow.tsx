...
const XPWindow = ({ 
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex flex-col overflow-hidden rounded-t-lg border-2 border-[#0058e6] bg-[#ece9d8] shadow-[8px_8px_20px_rgba(0,0,0,0.4)] absolute",
        className
      )}
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-white drop-shadow-md truncate max-w-[200px] md:max-w-none">
            {title}
          </span>
        </div>
